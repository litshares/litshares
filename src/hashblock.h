...
static unsigned char pblank[1];
    ...
    sph_echo512 (&ctx_echo, static_cast<const void*>(&hash[6]), 64);
    sph_echo512_close(&ctx_echo, static_cast<void*>(&hash[7]));
...
//    sph_hamsi512_close(&ctx_hamsi, static_cast<void*>(&hash[11]));
   ...
   sph_fugue512 (&ctx_fugue, static_cast<const void*>(&hash[7]), 64);
   sph_fugue512_close(&ctx_fugue, static_cast<void*>(&hash[8]));
