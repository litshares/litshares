...
unsigned int nStakeMinAge = 60 * 60 * 8  * 1;	//8h, minimum age for coin age:  6h
unsigned int nStakeMaxAge = 60 * 60 * 24 * 90;	//90d, stake age of full weight:  10d 60*60*24*10
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing

int64 nChainStartTime = 1423968485;
...
const string strMessageMagic = "Litshares Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if(nPoWHeight < 250 )	 nSubsidy = 4000000 * COIN;
...
static const int64 nTargetTimespan = 30 * 60; // 10 blocks  
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Litshares
    bool fStrictPayToScriptHash = true; // Always active in Litshares
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Litshares", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2015.2.15 Litshares created in NYC";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x66a50b1c6f8ee5ed23e69a732936f4e10d4fe0e59c51e74c927451346fd836f1"));
